...
word_to_index = {}
news_bag = []
specialization = ["二段式", "專科", "服儀", "襪", "緩漲", "刑罰", "月退", "證所稅"]
...
synonym.append( ["通姦", "通姦罪", "相姦", "外遇", "姦情", "姦情", "姦淫", "婚外性", "婚外情"] )
synonym.append( ["兩段式", "二段式", "待轉"] ) 
synonym.append( ["博弈", "賭場", "開賭", "賭博", "賭業", "博彩", "娛樂城", "拉斯維加斯"] )
synonym.append( ["罷工", "大罷工"] ) 
synonym.append( ["性交易", "嫖", "嫖客", "賣淫", "性工作者", "娼妓", "娼", "皮條客", "買春", "援交", "賣春", "內娼", "外娼", "坐檯", "妓女", "拉客", "雛妓", "嫖妓"] )
...
jieba.suggest_freq("證所稅", True)
jieba.suggest_freq("專科", True)
jieba.suggest_freq("緩漲", True)
jieba.suggest_freq("刑罰", True)
